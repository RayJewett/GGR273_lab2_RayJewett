...
//ol.proj.get("EPSG:32610").setExtent([-714599.805872, 5436159.742393, 2831748.360870, 6750394.651245]);
var wms_layers = [];
...
lyr_FishStocking2024_2.set('fieldAliases', {'DISTRICT': 'DISTRICT', 'WATERBODY': 'WATERBODY', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'SPECIES': 'SPECIES', 'GENOTYPE': 'GENOTYPE', 'STOCKED -': 'STOCKED -', 'STOCKING N': 'STOCKING N', 'PLANNED ST': 'PLANNED ST', 'Map Author': 'Map Author', 'Map Auth_1': 'Map Auth_1', 'MA3': 'MA3', 'MA': 'MA', 'MA2': 'MA2', 'NumStock': 'NumStock', });
...
lyr_FishStocking2024_2.set('fieldImages', {'DISTRICT': 'TextEdit', 'WATERBODY': 'TextEdit', 'Latitude': 'TextEdit', 'Longitude': 'TextEdit', 'SPECIES': 'TextEdit', 'GENOTYPE': 'TextEdit', 'STOCKED -': 'TextEdit', 'STOCKING N': 'TextEdit', 'PLANNED ST': 'TextEdit', 'Map Author': 'TextEdit', 'Map Auth_1': 'TextEdit', 'MA3': 'TextEdit', 'MA': 'TextEdit', 'MA2': 'TextEdit', 'NumStock': 'TextEdit', });
